...
class CoffeeController
{
    ...
    function CreateCoffeTables($types)
    {
        $coffeModel = new CoffeeModel();
        $coffeArray = $coffeModel->GetCoffeeByType($types);
        $result = "";

        //General a coffeeTable for each coffeeEntity in array
        foreach($coffeArray as $key => $coffee)
        {
            $result = $result . 
